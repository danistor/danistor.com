export const fr = {
  ...
  portfolio: {
    ...
    bithy: {
      title: "Plateforme E-commerce Bithy",
      category: "E-commerce",
      description: "Une boutique en ligne complète avec gestion des produits, fonctionnalité de panier et processus de paiement sécurisé.",
      challenge: "Design créatif et développement d'une boutique en ligne complète. Un délai de mise sur le marché rapide était essentiel.",
      solution: "Développement efficace d'une boutique en ligne complète avec un accent sur l'expérience utilisateur et le SEO.",
      results: {
        sales: "Commence à être visible dans la recherche Google",
        conversion: "Lancement réussi de la boutique",
      },
    },
    nahrin: {
      title: "CMS Headless Nahrin",
      category: "Système de gestion de contenu",
      description: "Un système de gestion de contenu pour une entreprise suisse.",
      challenge: "Le client avait besoin d'un système de gestion de contenu pour son site web.",
      solution: "J'ai développé un système de gestion de contenu pour leur site web.",
      results: {
        sales: "Commence à être visible dans la recherche Google",
        conversion: "Lancement réussi de la boutique",
      },
    ...
    crosare: {
      title: "Site web Crosare",
      category: "Site web",
      description: "Un site web pour une entreprise suisse.",
      challenge: "Le client avait besoin d'un site web pour son entreprise.",
      solution: "J'ai développé un site web pour leur entreprise.",
      results: {
        sales: "Commence à être visible dans la recherche Google",
        conversion: "Lancement réussi de la boutique",
      },
  ...
  form: {
    ...
    quote: {
      ...
      description: "Remplissez le formulaire ci-dessous pour discuter de votre projet et recevoir un devis personnalisé.",
    },
    project: {
  ...
  serviceDialog: {
    description: "Détails complets sur ce service et comment il peut bénéficier à votre entreprise.",
    features: "Fonctionnalités clés :",
    benefits: "Avantages :",
    benefitsList: {
      efficiency: "Efficacité opérationnelle accrue",
